...
@section('title', 'SIARAT | Tambah - Disposisi')
...
<div class="page-heading">
    <section class="section">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('disposisi.store') }}" method="POST" autocomplete="off">
                    @csrf
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-select" id="surat_masuk" name="surat_masuk">
                                    ...
                                    @foreach($suratmasuk as $sm)
                                        <option value="{{ $sm->id }}">{{ $sm->nomor }} - {{ $sm->pengirim }}</option>
                                    @endforeach
                                </select>
                                @error('surat_masuk')
                                    <div class="invalid-feedback d-block" role="alert">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea name="isi" id="isi" class="form-control" cols="30" rows="4" value="{{ old('isi') }}"></textarea>
                                @error('isi')
                                    <div class="invalid-feedback d-block" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </div>
